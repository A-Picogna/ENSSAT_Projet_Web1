            ...
            <div class="container-fluid">
                ...
                <div>
                    <ul class="nav navbar-nav">
                        <li><a href="<?php echo base_url();?>index.php/listeModules"><span class="glyphicon glyphicon-list"></span> Liste Modules</a></li>
						<li><a href="<?php echo base_url();?>index.php/afficheEnseignant"><span class="glyphicon glyphicon-file"></span> Ma fiche enseignant</a></li>
                        <li><a href="<?php echo base_url();?>index.php/home/listeUtilisateurs"><span class="glyphicon glyphicon-list-alt"></span> Voir les utilisateurs</a></li>
                    </ul>      
